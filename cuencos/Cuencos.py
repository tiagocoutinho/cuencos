...
from .graphics import CuencosGraphics

class Cuencos(QMainWindow):
    """Create the main window that stores all of the widgets necessary for the application."""

    def __init__(self, parent=None):
        """Initialize the components of the main window."""
        super(Cuencos, self).__init__(parent)
        self.resize(1024, 768)
        self.setWindowTitle('Cuencos')
        window_icon = pkg_resources.resource_filename('cuencos.images',
    ...
    def init_panel(self):
        self.g = CuencosGraphics(self.widget)
    ...
    def file_menu(self):
        ...
        self.open_action.setStatusTip('Open a file into Cuencos.')
    ...
    def tool_bar_items(self):
        ...
        open_icon = pkg_resources.resource_filename('cuencos.images',
